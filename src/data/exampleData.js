export const personData = [
  ...
  export const obiectData = [
    {id: 1, nume: 'the kitchen'},
    {id: 2, nume: 'the bathroom'},
    {id: 3, nume: 'the balcony'},
    {id: 4, nume: 'the window'},
    {id: 5, nume: 'the bedroom'},
    {id: 6, nume: 'the living room'},
    {id: 7, nume: 'the attic'},
    {id: 8, nume: 'the cellar'},
    {id: 9, nume: 'the closet'},
    {id: 10, nume: 'the staircase'},
  ];

  export const statusData = [
    {id: 1, nume: 'started cleaning'},
    {id: 2, nume: 'finished cleaning'},
  ];

  export const companyDomain = "acado.ro" 

  export default{
    personData,obiectData,statusData
  }